...
package com.eunoiaos.internal.statusbar;
...
public class NetworkTraffic extends TextView {
    ...
    private final EunoiaStatusBarItem.DarkReceiver mDarkReceiver =
            new EunoiaStatusBarItem.DarkReceiver() {
    ...
    private final EunoiaStatusBarItem.VisibilityReceiver mVisibilityReceiver =
            new EunoiaStatusBarItem.VisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        EunoiaStatusBarItem.Manager manager =
                EunoiaStatusBarItem.findManager((View) this);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EunoiaSettings.Secure.getUriFor(
                    EunoiaSettings.Secure.NETWORK_TRAFFIC_MODE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EunoiaSettings.Secure.getUriFor(
                    EunoiaSettings.Secure.NETWORK_TRAFFIC_POSITION),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EunoiaSettings.Secure.getUriFor(
                    EunoiaSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EunoiaSettings.Secure.getUriFor(
                    EunoiaSettings.Secure.NETWORK_TRAFFIC_UNITS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EunoiaSettings.Secure.getUriFor(
                    EunoiaSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS),
                    false, this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mMode = EunoiaSettings.Secure.getInt(resolver,
                EunoiaSettings.Secure.NETWORK_TRAFFIC_MODE, 0);
        mPosition = EunoiaSettings.Secure.getInt(resolver,
                EunoiaSettings.Secure.NETWORK_TRAFFIC_POSITION, POSITION_CENTER);
        mAutoHide = EunoiaSettings.Secure.getInt(resolver,
                EunoiaSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE, 0) == 1;
        mUnits = EunoiaSettings.Secure.getInt(resolver,
                EunoiaSettings.Secure.NETWORK_TRAFFIC_UNITS, UNITS_KILOBYTES);
        mShowUnits = EunoiaSettings.Secure.getInt(resolver,
                EunoiaSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS, SHOW_UNITS_ON);
