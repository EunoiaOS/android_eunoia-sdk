...
package com.eunoiaos.internal.applications;
...
public class LongScreen {
    ...
    public LongScreen(Context context) {
        ...
        mLongScreenAvailable = resources.getBoolean(
                com.eunoiaos.platform.internal.R.bool.config_haveHigherAspectRatioScreen);
    ...
    public void addApp(String packageName) {
        ...
        EunoiaSettings.System.putString(mContext.getContentResolver(),
                EunoiaSettings.System.LONG_SCREEN_APPS, String.join(",", mApps));
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EunoiaSettings.System.getUriFor(
                    EunoiaSettings.System.LONG_SCREEN_APPS), false, this,
                    UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            String apps = EunoiaSettings.System.getStringForUser(resolver,
                    EunoiaSettings.System.LONG_SCREEN_APPS,
