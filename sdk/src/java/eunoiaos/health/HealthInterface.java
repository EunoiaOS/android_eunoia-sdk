...
public class HealthInterface {
    ...
    private HealthInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                EunoiaContextConstants.Features.HEALTH) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link eunoiaos.health.HealthInterface}
     *
    ...
    public static IHealthInterface getService() {
        ...
        IBinder b = ServiceManager.getService(EunoiaContextConstants.EUNOIA_HEALTH_INTERFACE);
