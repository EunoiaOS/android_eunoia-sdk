...
public class TrustInterface {
     ...
     */
    public static final String TRUST_INTERFACE_PERMISSION = "eunoiaos.permission.TRUST_INTERFACE";
    ...
    private TrustInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                EunoiaContextConstants.Features.TRUST) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link eunoiaos.trust.TrustInterface}
     *
    ...
    public static ITrustInterface getService() {
        ...
        IBinder b = ServiceManager.getService(EunoiaContextConstants.EUNOIA_TRUST_INTERFACE);
