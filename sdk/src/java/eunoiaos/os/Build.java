...
/**
 * Information about the current EunoiaOS build, extracted from system properties.
 */
public class Build {
    /** Value used for when a build property is unknown. */
    public static final String UNKNOWN = "unknown";

    /** A build ID utilized to distinguish eunoiaos versions */
    public static final String EUNOIAOS_VERSION = getString("ro.eunoia.version");

    /** A build ID string meant for displaying to the user */
    public static final String EUNOIAOS_DISPLAY_VERSION = getString("ro.eunoia.display.version");

    private static final SparseArray<String> sdkMap;
    static
    {
        sdkMap = new SparseArray<String>();
        sdkMap.put(EUNOIA_VERSION_CODES.APRICOT, "Apricot");
        sdkMap.put(EUNOIA_VERSION_CODES.BOYSENBERRY, "Boysenberry");
        sdkMap.put(EUNOIA_VERSION_CODES.CANTALOUPE, "Cantaloupe");
        sdkMap.put(EUNOIA_VERSION_CODES.DRAGON_FRUIT, "Dragon Fruit");
        sdkMap.put(EUNOIA_VERSION_CODES.ELDERBERRY, "Elderberry");
        sdkMap.put(EUNOIA_VERSION_CODES.FIG, "Fig");
        sdkMap.put(EUNOIA_VERSION_CODES.GUAVA, "Guava");
        sdkMap.put(EUNOIA_VERSION_CODES.HACKBERRY, "Hackberry");
        sdkMap.put(EUNOIA_VERSION_CODES.ILAMA, "Ilama");
    }

    /** Various version strings. */
    public static class EUNOIA_VERSION {
        /**
         * The user-visible SDK version of the framework; its possible
         * values are defined in {@link Build.EUNOIA_VERSION_CODES}.
         *
         * Will return 0 if the device does not support the Eunoia SDK.
         */
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.eunoia.build.version.plat.sdk", 0);
    }

    /**
     * Enumeration of the currently known SDK version codes.  These are the
     * values that can be found in {@link EUNOIA_VERSION#SDK_INT}.  Version numbers
     ...
     *     if (Build.EUNOIA_VERSION.SDK_INT >= Build.EUNOIA_VERSION_CODES.BOYSENBERRY) {
     ...
     * </pre>
     */
    public static class EUNOIA_VERSION_CODES {
        /**
         ...
         * new features:</p>
         * <ul>
         * <li>Profiles API via {@link eunoiaos.app.ProfileManager}
         * <li>Hardware Abstraction Framework Access via
         * {@link eunoiaos.hardware.EunoiaHardwareManager} (Not for use by 3rd parties)
         * <li>Introductory Settings Provider {@link eunoiaos.providers.EunoiaSettings}
         * </ul>
         */
         ...
         * {@link eunoiaos.power.PerformanceManager}</li>
         * <li>Numerous new "System" settings exposed via the
         * {@link eunoiaos.providers.EunoiaSettings.System} interface</li>
         * </ul>
         */
         ...
         * {@link eunoiaos.weather.EunoiaWeatherManager}</li>
         * <li>Weather provider api to provide weather data to any listener on the device
         * {@link eunoiaos.weatherservice.WeatherProviderService}</li>
         * <li>Parceling helper class {@link eunoiaos.os.Concierge} to help with parcel
         ...
         * {@link eunoiaos.hardware.EunoiaHardwareManager}, as well as do picture adjustment</li>
         * <li>Extended capabilities of the LiveDisplay interfaces, now providing
         * {@link eunoiaos.hardware.LiveDisplayConfig} and a dedicated
         * {@link eunoiaos.hardware.LiveDisplayManager}</li>
         * <li>Added new settings, such as LOCKSCREEN_ROTATION and DISPLAY_LOW_POWER
         * to {@link eunoiaos.providers.EunoiaSettings}</li>
         * </ul>
         *
         * Signing out, Adnan \u270C
         */
