...
import eunoiaos.os.Build.EUNOIA_VERSION_CODES;
...
public final class Concierge {
    ...
    /**
     * Since there might be a case where new versions of the eunoia framework use applications running
     ...
     * {@link EUNOIA_VERSION_CODES}
     * @hide
     */
    public static final int PARCELABLE_VERSION = EUNOIA_VERSION_CODES.ILAMA;
