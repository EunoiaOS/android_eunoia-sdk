...
package eunoiaos.content;

import android.Manifest;

/**
 * EunoiaOS specific intent definition class.
 */
public class Intent {
    ...
    public static final String ACTION_RECENTS_LONG_PRESS =
            "eunoiaos.intent.action.RECENTS_LONG_PRESS";
    ...
    public static final String EXTRA_RECENTS_LONG_PRESS_RELEASE =
            "eunoiaos.intent.extra.RECENTS_LONG_PRESS_RELEASE";
    ...
    public static final String ACTION_SCREEN_CAMERA_GESTURE =
            "eunoiaos.intent.action.SCREEN_CAMERA_GESTURE";

    /**
     * Broadcast action: perform any initialization required for EunoiaHW services.
     ...
     *
     * Requires {@link eunoiaos.platform.Manifest.permission#HARDWARE_ABSTRACTION_ACCESS}.
     * @hide
     */
    public static final String ACTION_INITIALIZE_EUNOIA_HARDWARE =
            "eunoiaos.intent.action.INITIALIZE_EUNOIA_HARDWARE";
    ...
    public static final String ACTION_LID_STATE_CHANGED =
            "eunoiaos.intent.action.LID_STATE_CHANGED";
    ...
    public static final String EXTRA_LID_STATE =
            "eunoiaos.intent.extra.LID_STATE";
    ...
    public static final String ACTION_UPDATE_POWER_MENU =
            "eunoiaos.intent.action.UPDATE_POWER_MENU";
    ...
    public static final String ACTION_INITIALIZE_LIVEDISPLAY =
            "eunoiaos.intent.action.INITIALIZE_LIVEDISPLAY";
}
