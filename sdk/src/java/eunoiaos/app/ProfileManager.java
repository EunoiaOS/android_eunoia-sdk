...
public class ProfileManager {
    ...
    public static final String INTENT_ACTION_PROFILE_SELECTED =
            "eunoiaos.platform.intent.action.PROFILE_SELECTED";
    ...
    public static final String INTENT_ACTION_PROFILE_UPDATED =
            "eunoiaos.platform.intent.action.PROFILE_UPDATED";
    ...
    public static final String INTENT_ACTION_PROFILE_TRIGGER_STATE_CHANGED =
            "eunoiaos.platform.intent.action.INTENT_ACTION_PROFILE_TRIGGER_STATE_CHANGED";
    ...
    public static final String ACTION_PROFILE_PICKER =
            "eunoiaos.platform.intent.action.PROFILE_PICKER";
    ...
    public static final String EXTRA_PROFILE_SHOW_NONE =
            "eunoiaos.platform.intent.extra.profile.SHOW_NONE";
    ...
    public static final String EXTRA_PROFILE_EXISTING_UUID =
            "eunoiaos.platform.extra.profile.EXISTING_UUID";
    ...
    public static final String EXTRA_PROFILE_TITLE =
            "eunoiaos.platform.intent.extra.profile.TITLE";
    ...
    public static final String EXTRA_PROFILE_PICKED_UUID =
            "eunoiaos.platform.intent.extra.profile.PICKED_UUID";
    ...
    public static final String PROFILES_STATE_CHANGED_ACTION =
        "eunoiaos.platform.app.profiles.PROFILES_STATE_CHANGED";
    ...
    public static final String EXTRA_PROFILE_DIALOG_THEME =
            "eunoiaos.platform.intent.extra.profile.DIALOG_THEME";
    ...
    private ProfileManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                eunoiaos.app.EunoiaContextConstants.Features.PROFILES) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link eunoiaos.app.ProfileManager}
     * @param context
    ...
    static public IProfileManager getService() throws RemoteException {
        ...
        IBinder b = ServiceManager.getService(EunoiaContextConstants.EUNOIA_PROFILE_SERVICE);
        sService = IProfileManager.Stub.asInterface(b);

        if (sService == null) {
            throw new RemoteException("Couldn't get " +
                                      EunoiaContextConstants.EUNOIA_PROFILE_SERVICE +
                                      " on binder");
        }
        return sService;
    }
