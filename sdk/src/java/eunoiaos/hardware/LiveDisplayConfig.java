...
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_COLOR_BALANCE;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_PICTURE_ADJUSTMENT;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_FIRST;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_LAST;
...
import eunoiaos.os.Build;
import eunoiaos.os.Concierge;
import eunoiaos.os.Concierge.ParcelInfo;
...
public class LiveDisplayConfig implements Parcelable {
    ...
    private LiveDisplayConfig(Parcel parcel) {
        ...
        if (parcelableVersion >= Build.EUNOIA_VERSION_CODES.FIG) {
