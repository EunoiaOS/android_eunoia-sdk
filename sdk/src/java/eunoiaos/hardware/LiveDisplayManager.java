...
public class LiveDisplayManager {
    ...
    private LiveDisplayManager(Context context) {
        ...
        if (!context.getPackageManager().hasSystemFeature(
                EunoiaContextConstants.Features.LIVEDISPLAY) || !checkService()) {
    ...
    /**
     * Get or create an instance of the {@link eunoiaos.hardware.LiveDisplayManager}
     * @param context
    ...
    public static ILiveDisplayService getService() {
        ...
        IBinder b = ServiceManager.getService(EunoiaContextConstants.EUNOIA_LIVEDISPLAY_SERVICE);
        if (b != null) {
