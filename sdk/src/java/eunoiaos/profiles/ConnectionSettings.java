...
public final class ConnectionSettings implements Parcelable {
    ...
    private static final int EUNOIA_MODE_2G = 0;
    private static final int EUNOIA_MODE_3G = 1;
    private static final int EUNOIA_MODE_4G = 2;
    private static final int EUNOIA_MODE_2G3G = 3;
    private static final int EUNOIA_MODE_ALL = 4;
    ...
    public void processOverride(Context context) {
        ...
        switch (getConnectionId()) {
            ...
            case PROFILE_CONNECTION_2G3G4G:
                if (Build.EUNOIA_VERSION.SDK_INT >= Build.EUNOIA_VERSION_CODES.ELDERBERRY) {
    ...
    public void readFromParcel(Parcel in) {
        ...
        if (parcelableVersion >= Build.EUNOIA_VERSION_CODES.BOYSENBERRY) {
        ...
        if (parcelableVersion >= Build.EUNOIA_VERSION_CODES.ELDERBERRY) {
            if (mConnectionId == PROFILE_CONNECTION_2G3G4G) {
                mSubId = in.readInt();
            }
        }
