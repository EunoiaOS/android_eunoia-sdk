...
package com.eunoiaos.tests.profiles.unit;
...
public class ProfileManagerTest extends AndroidTestCase {
    ...
    public void testManagerProfileIsEnabled() {
        ...
        assertTrue(EunoiaSettings.System.putString(getContext().getContentResolver(),
                EunoiaSettings.System.SYSTEM_PROFILES_ENABLED, enabledValue));

        // check that we successfully enabled them via system setting
        assertEquals(enabledValue, EunoiaSettings.System.getString(getContext().getContentResolver(),
        ...
        assertTrue(EunoiaSettings.System.putString(getContext().getContentResolver(),
                EunoiaSettings.System.SYSTEM_PROFILES_ENABLED, disabledValue));

        // check that we successfully disable them via system setting
        assertEquals(disabledValue, EunoiaSettings.System.getString(getContext().getContentResolver(),
                EunoiaSettings.System.SYSTEM_PROFILES_ENABLED));
    ...
    public void testGetProfileNames() {
        ...
        // These defaults are pulled from the default xml in the eunoia.platform resource package
