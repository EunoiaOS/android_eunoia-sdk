...
package com.eunoiaos.tests.versioning.unit.apiv2;
...
public class ApiV2PriorReleaseInterfaces {
    ...
    //EunoiaHardwareManager Aidl (IEunoiaHardwareService)
    static {
        Map<String, Integer> hardwareMap = getInternalInterfaceMap("IEunoiaHardwareService");
        // APRICOT + BOYSENBERRY + CANTALOUPE
    ...
    //EunoiaStatusBarManager Aidl (IEunoiaStatusBarManager)
    static {
        Map<String, Integer> statusBarMap = getInternalInterfaceMap("IEunoiaStatusBarManager");
        // APRICOT + BOYSENBERRY + CANTALOUPE
    ...
    //EunoiaTelephonyManager Aidl (IEunoiaTelephonyManager)
    static {
        Map<String, Integer> telephonyMap = getInternalInterfaceMap("IEunoiaTelephonyManager");
        // APRICOT + BOYSENBERRY + CANTALOUPE
