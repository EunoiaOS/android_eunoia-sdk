...
package com.eunoiaos.tests.hardware;
...
import eunoiaos.hardware.DisplayMode;

import com.eunoiaos.tests.TestActivity;

/**
 * Created by adnan on 8/31/15.
 */
public class EunoiaHardwareTest extends TestActivity {
    private EunoiaHardwareManager mHardwareManager;

    private static final List<Integer> FEATURES = Arrays.asList(
            EunoiaHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT,
            EunoiaHardwareManager.FEATURE_COLOR_ENHANCEMENT,
            EunoiaHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION,
            EunoiaHardwareManager.FEATURE_HIGH_TOUCH_SENSITIVITY,
            EunoiaHardwareManager.FEATURE_KEY_DISABLE,
            EunoiaHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT,
            EunoiaHardwareManager.FEATURE_TOUCH_HOVERING,
            EunoiaHardwareManager.FEATURE_AUTO_CONTRAST,
            EunoiaHardwareManager.FEATURE_DISPLAY_MODES
    );
    ...
    public void onCreate(Bundle icicle) {
        ...
        mHardwareManager = EunoiaHardwareManager.getInstance(this);
    }
    ...
    private boolean vibratorSupported() {
        if (mHardwareManager.isSupported(EunoiaHardwareManager.FEATURE_VIBRATOR)) {
            return true;
        } else {
            Toast.makeText(EunoiaHardwareTest.this, "Vibrator not supported",
    ...
    private boolean displayColorCalibrationSupported() {
        if (mHardwareManager.isSupported(EunoiaHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION)) {
            return true;
        } else {
            Toast.makeText(EunoiaHardwareTest.this, "Display Color Calibration not supported",
                    Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    private boolean displayModesSupported() {
        if (mHardwareManager.isSupported(EunoiaHardwareManager.FEATURE_DISPLAY_MODES)) {
            return true;
        } else {
            Toast.makeText(EunoiaHardwareTest.this, "Display modes not supported",
                    Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    private Test[] mTests = new Test[] {
            new Test("Test get supported features") {
                public void run() {
                    Toast.makeText(EunoiaHardwareTest.this, "Supported features " +
            ...
            new Test("Test boolean features enabled") {
                ...
                protected void run() {
                    ...
                    Toast.makeText(EunoiaHardwareTest.this, "Features " +
                                    builder.toString(),
                            Toast.LENGTH_SHORT).show();
                }
            },
            new Test("Test get vibrator intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Vibrator intensity " +
            ...
            new Test("Test get vibrator default intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Vibrator default intensity " +
            ...
            new Test("Test get vibrator max intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Vibrator max intensity " +
            ...
            new Test("Test get vibrator min intensity") {
                ...
                protected void run() {
                    if (vibratorSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Vibrator min intensity " +
            ...
            new Test("Test Display Color Calibration") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Display Color Calibration " +
            ...
            new Test("Test Default Display Color Calibration") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Default Display Color Calibration " +
            ...
            new Test("Test Display Color Calibration Max") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Display Color Calibration Max " +
            ...
            new Test("Test Display Color Calibration Min") {
                ...
                protected void run() {
                    if (displayColorCalibrationSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Display Color Calibration Min " +
            ...
            new Test("Test Get Display Modes") {
                ...
                protected void run() {
                    if (displayModesSupported()) {
                        ...
                        Toast.makeText(EunoiaHardwareTest.this, "Display modes: \n"
            ...
            new Test("Test Get Current Display Mode") {
                ...
                protected void run() {
                    if (displayModesSupported()) {
                        Toast.makeText(EunoiaHardwareTest.this, "Default Display Mode " +
