package com.eunoiaos.tests.hardware.unit;
...
public class LiveDisplayManagerTest extends AndroidTestCase {
    ...
    private EunoiaHardwareManager mHardware;
    ...
    protected void setUp() throws Exception {
        ...
        Assume.assumeTrue(mContext.getPackageManager().hasSystemFeature(
                EunoiaContextConstants.Features.LIVEDISPLAY));
    ...
    public void testOutdoorMode() throws Exception {
        ...
        assertTrue(mHardware.isSupported(EunoiaHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT));

        mLiveDisplay.setMode(LiveDisplayManager.MODE_OUTDOOR);
        Thread.sleep(1000);
        assertTrue(mHardware.get(EunoiaHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT));

        mLiveDisplay.setMode(LiveDisplayManager.MODE_OFF);
        Thread.sleep(1000);
        assertFalse(mHardware.get(EunoiaHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT));
    }
