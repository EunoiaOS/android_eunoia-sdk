...
import com.eunoiaos.eunoiasettings.EunoiaDatabaseHelper;
import com.eunoiaos.eunoiasettings.EunoiaSettingsProvider;
 ...
 */
public class EunoiaSettingsProviderDefaultsTest extends AndroidTestCase {
    ...
    static {
        ...
        SYSTEM_SETTINGS_DEFAULTS.add(new Setting(
                EunoiaSettings.System.FORCE_SHOW_NAVBAR,
    ...
    */
    ...
    protected void setUp() throws Exception {
        ...
        mHasMigratedSettings = getContext().getSharedPreferences(EunoiaSettingsProvider.TAG,
                Context.MODE_PRIVATE).getBoolean(EunoiaSettingsProvider.PREF_HAS_MIGRATED_EUNOIA_SETTINGS,
                false);
        mRemoteResources = getRemoteResources("com.eunoiaos.eunoiasettings");
    }
    ...
    public void testVerifySystemSettingsDefault() {
        if (verifyNotMigratedSettings()) {
            for (Setting setting : SYSTEM_SETTINGS_DEFAULTS) {
                verifyDefaultSettingForTable(setting, EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SYSTEM);
            }
        }
    }
    ...
    public void testVerifySecureSettingsDefaults() {
        if (verifyNotMigratedSettings()) {
            for (Setting setting : SECURE_SETTINGS_DEFAULTS) {
                verifyDefaultSettingForTable(setting, EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SECURE);
            }
        }
    }
    ...
    public void testVerifyGlobalSettingsDefaults() {
        if (verifyNotMigratedSettings()) {
            for (Setting setting : GLOBAL_SETTINGS_DEFAULTS) {
                verifyDefaultSettingForTable(setting, EunoiaDatabaseHelper.EunoiaTableNames.TABLE_GLOBAL);
            }
        }
    }
    ...
    private void verifyDefaultSettingForTable(Setting setting, String table) {
        ...
        try {
            int identifier = mRemoteResources.getIdentifier(
                    setting.mDefResName, setting.mType, "com.eunoiaos.eunoiasettings");
    ...
    private int getIntForTable(Setting setting, String table)
            throws EunoiaSettings.EunoiaSettingNotFoundException {
        switch (table) {
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SYSTEM:
                return EunoiaSettings.System.getIntForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SECURE:
                return EunoiaSettings.Secure.getIntForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_GLOBAL:
                return EunoiaSettings.Global.getIntForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            default:
    ...
    private String getStringForTable(Setting setting, String table)
        ...
        switch (table) {
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SYSTEM:
                return EunoiaSettings.System.getStringForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_SECURE:
                return EunoiaSettings.Secure.getStringForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            case EunoiaDatabaseHelper.EunoiaTableNames.TABLE_GLOBAL:
                return EunoiaSettings.Global.getStringForUser(mContentResolver, setting.mKey,
                        UserHandle.USER_SYSTEM);
            default:
                throw new AssertionError("Invalid or empty table!");
        }
