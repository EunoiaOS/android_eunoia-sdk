...
public class SettingsHelper {
    ...
    private static final String EUNOIASETTINGS_GLOBAL = EunoiaSettings.Global.CONTENT_URI.toString();
    private static final String EUNOIASETTINGS_SECURE = EunoiaSettings.Secure.CONTENT_URI.toString();
    private static final String EUNOIASETTINGS_SYSTEM = EunoiaSettings.System.CONTENT_URI.toString();
    ...
    public String getString(Uri settingsUri) {
        ...
        } else if (uri.startsWith(EUNOIASETTINGS_SECURE)) {
            return EunoiaSettings.Secure.getString(resolver, uri.substring(EUNOIASETTINGS_SECURE.length()));
        } else if (uri.startsWith(EUNOIASETTINGS_SYSTEM)) {
            return EunoiaSettings.System.getString(resolver, uri.substring(EUNOIASETTINGS_SYSTEM.length()));
        } else if (uri.startsWith(EUNOIASETTINGS_GLOBAL)) {
            return EunoiaSettings.Global.getString(resolver, uri.substring(EUNOIASETTINGS_GLOBAL.length()));
        }
        return null;
    }
    ...
    public int getInt(Uri settingsUri, int def) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            return EunoiaSettings.Secure.getInt(resolver, uri.substring(EUNOIASETTINGS_SECURE.length()), def);
        } else if (uri.startsWith(EUNOIASETTINGS_SYSTEM)) {
            return EunoiaSettings.System.getInt(resolver, uri.substring(EUNOIASETTINGS_SYSTEM.length()), def);
        } else if (uri.startsWith(EUNOIASETTINGS_GLOBAL)) {
            return EunoiaSettings.Global.getInt(resolver, uri.substring(EUNOIASETTINGS_GLOBAL.length()), def);
        }
        return def;
    }
    ...
    public void putString(Uri settingsUri, String value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            EunoiaSettings.Secure.putString(resolver, uri.substring(EUNOIASETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(EUNOIASETTINGS_SYSTEM)) {
            EunoiaSettings.System.putString(resolver, uri.substring(EUNOIASETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(EUNOIASETTINGS_GLOBAL)) {
            EunoiaSettings.Global.putString(resolver, uri.substring(EUNOIASETTINGS_GLOBAL.length()), value);
        }
    }
    ...
    public void putInt(Uri settingsUri, int value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            ...
            EunoiaSettings.Secure.putInt(resolver, uri.substring(EUNOIASETTINGS_SECURE.length()), value);
        } else if (uri.startsWith(EUNOIASETTINGS_SYSTEM)) {
            EunoiaSettings.System.putInt(resolver, uri.substring(EUNOIASETTINGS_SYSTEM.length()), value);
        } else if (uri.startsWith(EUNOIASETTINGS_GLOBAL)) {
            EunoiaSettings.Global.putInt(resolver, uri.substring(EUNOIASETTINGS_GLOBAL.length()), value);
        }
    }
