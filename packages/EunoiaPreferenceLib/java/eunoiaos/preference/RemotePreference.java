...
public class RemotePreference extends SelfRemovingPreference
    ...
    public static final String ACTION_REFRESH_PREFERENCE =
            "eunoiaos.intent.action.REFRESH_PREFERENCE";

    public static final String ACTION_UPDATE_PREFERENCE =
            "eunoiaos.intent.action.UPDATE_PREFERENCE";

    public static final String META_REMOTE_RECEIVER =
            "com.eunoiaos.settings.summary.receiver";

    public static final String META_REMOTE_KEY =
            "com.eunoiaos.settings.summary.key";

    public static final String EXTRA_ENABLED = ":eunoia:pref_enabled";
    public static final String EXTRA_KEY = ":eunoia:pref_key";
    public static final String EXTRA_SUMMARY = ":eunoia:pref_summary";
