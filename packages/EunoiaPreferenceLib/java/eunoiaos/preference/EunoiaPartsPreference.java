...
import eunoiaos.preference.RemotePreference;
 ...
 */
public class EunoiaPartsPreference extends RemotePreference {

    private static final String TAG = "EunoiaPartsPreference";

    private final PartInfo mPart;

    private final Context mContext;

    public EunoiaPartsPreference(Context context, AttributeSet attrs,
    ...
    public EunoiaPartsPreference(Context context, AttributeSet attrs, int defStyle) {
