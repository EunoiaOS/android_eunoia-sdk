...
import static eunoiaos.preference.R.styleable.eunoia_Searchable;
import static eunoiaos.preference.R.styleable.eunoia_Searchable_xmlRes;
...
public class PartsList {
    ...
    public static final String EXTRA_PART = ":eunoia:part";

    public static final String EUNOIAPARTS_PACKAGE = "com.eunoiaos.eunoiaparts";

    public static final ComponentName EUNOIAPARTS_ACTIVITY = new ComponentName(
            EUNOIAPARTS_PACKAGE, EUNOIAPARTS_PACKAGE + ".PartsActivity");

    public static final String PARTS_ACTION_PREFIX = EUNOIAPARTS_PACKAGE + ".parts";
    ...
    private void loadParts() {
        synchronized (mParts) {
            ...
            try {
                final Resources r = pm.getResourcesForApplication(EUNOIAPARTS_PACKAGE);
                if (r == null) {
                    return;
                }
                int resId = r.getIdentifier("parts_catalog", "xml", EUNOIAPARTS_PACKAGE);
                if (resId > 0) {
                    loadPartsFromResourceLocked(r, resId, mParts);
                }
            } catch (PackageManager.NameNotFoundException e) {
                // no eunoiaparts installed
            }
        }
    }
        ...
        try {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("part".equals(nodeName)) {
                    ...
                    sa = res.obtainAttributes(attrs, eunoia_Searchable);
                    info.setXmlRes(sa.getResourceId(eunoia_Searchable_xmlRes, 0));
