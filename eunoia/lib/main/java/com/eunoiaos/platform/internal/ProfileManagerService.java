...
import eunoiaos.app.ProfileGroup;
import eunoiaos.app.ProfileManager;
import eunoiaos.app.IProfileManager;
...
/** @hide */
public class ProfileManagerService extends EunoiaSystemService {

    private static final String TAG = "EunoiaProfileService";
    ...
    private class ProfilesObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            int state = EunoiaSettings.System.getInt(mContext.getContentResolver(),
    ...
    public String getFeatureDeclaration() {
        return EunoiaContextConstants.Features.PROFILES;
    }
    ...
    public void onStart() {
        ...
        mWildcardGroup = new NotificationGroup(
                mContext.getString(com.eunoiaos.platform.internal.R.string.wildcardProfile),
                com.eunoiaos.platform.internal.R.string.wildcardProfile,
                mWildcardUUID);
        ...
        if (mContext.getPackageManager().hasSystemFeature(
                EunoiaContextConstants.Features.PROFILES)) {
            publishBinderService(EunoiaContextConstants.EUNOIA_PROFILE_SERVICE, mService);
        } else {
            Log.wtf(TAG, "Eunoia profile service started by system server but feature xml not" +
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_ACTIVITY_MANAGER_READY) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    EunoiaSettings.System.getUriFor(EunoiaSettings.System.SYSTEM_PROFILES_ENABLED),
    ...
    private void enforceChangePermissions() {
        mContext.enforceCallingOrSelfPermission(
                eunoiaos.platform.Manifest.permission.MODIFY_PROFILES,
    ...
    private void initialiseStructure() throws XmlPullParserException, IOException {
        XmlResourceParser xml = mContext.getResources().getXml(
                com.eunoiaos.platform.internal.R.xml.profile_default);
        try {
