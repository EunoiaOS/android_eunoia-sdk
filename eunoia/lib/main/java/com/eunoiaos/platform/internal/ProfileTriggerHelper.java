...
import eunoiaos.app.Profile.ProfileTrigger;
    ...
    public ProfileTriggerHelper(Context context, Handler handler,
       ...
       // mIntentFilter.addAction(AudioManager.A2DP_ROUTE_CHANGED_ACTION);
        ...
        mContext.getContentResolver().registerContentObserver(
                EunoiaSettings.System.getUriFor(EunoiaSettings.System.SYSTEM_PROFILES_ENABLED), false,
                mSettingsObserver);
    }

    public void updateEnabled() {
        boolean enabled = EunoiaSettings.System.getInt(mContext.getContentResolver(),
                EunoiaSettings.System.SYSTEM_PROFILES_ENABLED, 1) == 1;
