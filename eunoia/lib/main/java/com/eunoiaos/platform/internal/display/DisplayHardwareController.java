 ...
 */
package com.eunoiaos.platform.internal.display;
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_CABC);
    private static final Uri DISPLAY_READING_MODE =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_READING_MODE);
    private static final Uri DISPLAY_ANTI_FLICKER =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_ANTI_FLICKER);

    public DisplayHardwareController(Context context, Handler handler) {
        super(context, handler);

        mHardware = EunoiaHardwareManager.getInstance(mContext);
        mUseCABC = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT);
        mDefaultCABC = mContext.getResources().getBoolean(
                com.eunoiaos.platform.internal.R.bool.config_defaultCABC);

        mUseColorEnhancement = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_COLOR_ENHANCEMENT);
        mDefaultColorEnhancement = mContext.getResources().getBoolean(
                com.eunoiaos.platform.internal.R.bool.config_defaultColorEnhancement);

        mUseAutoContrast = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_AUTO_CONTRAST);
        mDefaultAutoContrast = mContext.getResources().getBoolean(
                com.eunoiaos.platform.internal.R.bool.config_defaultAutoContrast);

        mUseColorAdjustment = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION);

        mUseDisplayModes = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_DISPLAY_MODES);

        mUseReaderMode = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_READING_ENHANCEMENT);

        mUseAntiFlicker = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_ANTI_FLICKER);
        mDefaultAntiFlicker = mContext.getResources().getBoolean(
                com.eunoiaos.platform.internal.R.bool.config_defaultAntiFlicker);
    ...
    private void updateAutoContrast() {
        ...
        mHardware.set(EunoiaHardwareManager.FEATURE_AUTO_CONTRAST, isAutoContrastEnabled());
    }
    ...
    private void updateColorEnhancement() {
        ...
        mHardware.set(EunoiaHardwareManager.FEATURE_COLOR_ENHANCEMENT,
    ...
    private void updateCABCMode() {
        ...
        mHardware.set(EunoiaHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT, isCABCEnabled());
    }
    ...
    private void updateAntiFlicker() {
        ...
        mHardware.set(EunoiaHardwareManager.FEATURE_ANTI_FLICKER, isAntiFlickerEnabled());
    }
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(EunoiaSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(EunoiaSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(EunoiaSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(EunoiaSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(EunoiaSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(EunoiaSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(EunoiaSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(EunoiaSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
    ...
    boolean isAntiFlickerEnabled() {
        return mUseAntiFlicker &&
                getBoolean(EunoiaSettings.System.DISPLAY_ANTI_FLICKER, mDefaultAntiFlicker);
    }
    ...
    boolean setAntiFlickerEnabled(boolean enabled) {
        ...
        putBoolean(EunoiaSettings.System.DISPLAY_ANTI_FLICKER, enabled);
        return true;
    }
}
