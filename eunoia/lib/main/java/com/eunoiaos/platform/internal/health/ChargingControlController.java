...
import static eunoiaos.health.HealthInterface.MODE_NONE;
import static eunoiaos.health.HealthInterface.MODE_AUTO;
import static eunoiaos.health.HealthInterface.MODE_MANUAL;
import static eunoiaos.health.HealthInterface.MODE_LIMIT;

public class ChargingControlController extends EunoiaHealthFeature {
    private final IChargingControl mChargingControl;
    private final ContentResolver mContentResolver;
    private final ChargingControlNotification mChargingNotification;
    private EunoiaHealthBatteryBroadcastReceiver mBattReceiver;
    ...
    // Settings uris
    private final Uri MODE_URI = EunoiaSettings.System.getUriFor(
            EunoiaSettings.System.CHARGING_CONTROL_MODE);
    private final Uri LIMIT_URI = EunoiaSettings.System.getUriFor(
            EunoiaSettings.System.CHARGING_CONTROL_LIMIT);
    private final Uri ENABLED_URI = EunoiaSettings.System.getUriFor(
            EunoiaSettings.System.CHARGING_CONTROL_ENABLED);
    private final Uri START_TIME_URI = EunoiaSettings.System.getUriFor(
            EunoiaSettings.System.CHARGING_CONTROL_START_TIME);
    private final Uri TARGET_TIME_URI = EunoiaSettings.System.getUriFor(
            EunoiaSettings.System.CHARGING_CONTROL_TARGET_TIME);
    ...
    private static final String INTENT_PARTS =
            "com.eunoiaos.eunoiaparts.CHARGING_CONTROL_SETTINGS";
    ...
    public boolean setEnabled(boolean enabled) {
        putBoolean(EunoiaSettings.System.CHARGING_CONTROL_ENABLED, enabled);
        return true;
    }
    ...
    public boolean setMode(int mode) {
        ...
        putInt(EunoiaSettings.System.CHARGING_CONTROL_MODE, mode);
        return true;
    }
    ...
    public boolean setStartTime(int time) {
        ...
        putInt(EunoiaSettings.System.CHARGING_CONTROL_START_TIME, time);
        return true;
    }
    ...
    public boolean setTargetTime(int time) {
        ...
        putInt(EunoiaSettings.System.CHARGING_CONTROL_TARGET_TIME, time);
        return true;
    }
    ...
    public boolean setLimit(int limit) {
        ...
        putInt(EunoiaSettings.System.CHARGING_CONTROL_LIMIT, limit);
        return true;
    }
    ...
    private void onPowerConnected() {
        if (mBattReceiver == null) {
            mBattReceiver = new EunoiaHealthBatteryBroadcastReceiver();
        }
    ...
    private void handleSettingChange() {
        mConfigEnabled = EunoiaSettings.System.getInt(mContentResolver,
                EunoiaSettings.System.CHARGING_CONTROL_ENABLED, 0)
                != 0;
        mConfigLimit = EunoiaSettings.System.getInt(mContentResolver,
                EunoiaSettings.System.CHARGING_CONTROL_LIMIT,
                mDefaultLimit);
        mConfigMode = EunoiaSettings.System.getInt(mContentResolver,
                EunoiaSettings.System.CHARGING_CONTROL_MODE,
                mDefaultMode);
        mConfigStartTime = EunoiaSettings.System.getInt(mContentResolver,
                EunoiaSettings.System.CHARGING_CONTROL_START_TIME,
                mDefaultStartTime);
        mConfigTargetTime = EunoiaSettings.System.getInt(mContentResolver,
                EunoiaSettings.System.CHARGING_CONTROL_TARGET_TIME,
                mDefaultTargetTime);
    ...
    private class EunoiaHealthBatteryBroadcastReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (!mIsPowerConnected) {
                return;
    ...
    class ChargingControlNotification {
        ...
        private static final String ACTION_CHARGING_CONTROL_CANCEL_ONCE =
                "eunoiaos.platform.intent.action.CHARGING_CONTROL_CANCEL_ONCE";
        private static final String CHARGING_CONTROL_CHANNEL_ID = "EunoiaHealthChargingControl";
        ...
        ChargingControlNotification(Context context) {
            ...
            mContext.registerReceiver(new EunoiaHealthNotificationBroadcastReceiver(),
                    notificationFilter);
        }
        ...
        private class EunoiaHealthNotificationBroadcastReceiver extends BroadcastReceiver {
            @Override
            public void onReceive(Context context, Intent intent) {
