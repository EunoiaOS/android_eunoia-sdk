...
import static eunoiaos.hardware.LiveDisplayManager.MODE_AUTO;
import static eunoiaos.hardware.LiveDisplayManager.MODE_DAY;
import static eunoiaos.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_TEMPERATURE_DAY =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_TEMPERATURE_DAY);
    private static final Uri DISPLAY_TEMPERATURE_NIGHT =
            EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    ...
    public ColorTemperatureController(Context context,
        ...
        mUseColorBalance = mHardware
                .isSupported(EunoiaHardwareManager.FEATURE_COLOR_BALANCE);
        ...
        mDefaultDayTemperature = mContext.getResources().getInteger(
                com.eunoiaos.platform.internal.R.integer.config_dayColorTemperature);
        mDefaultNightTemperature = mContext.getResources().getInteger(
                com.eunoiaos.platform.internal.R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        com.eunoiaos.platform.internal.R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        com.eunoiaos.platform.internal.R.integer.config_maxColorTemperature));

        mColorBalanceCurve = com.eunoiaos.internal.util.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.eunoiaos.internal.util.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(EunoiaSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(EunoiaSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(EunoiaSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(EunoiaSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
