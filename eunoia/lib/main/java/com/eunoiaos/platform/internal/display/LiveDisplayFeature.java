...
import com.eunoiaos.platform.internal.display.LiveDisplayService.State;
...
import static com.eunoiaos.platform.internal.display.LiveDisplayService.ALL_CHANGED;
import static com.eunoiaos.platform.internal.display.LiveDisplayService.DISPLAY_CHANGED;
import static com.eunoiaos.platform.internal.display.LiveDisplayService.MODE_CHANGED;
import static com.eunoiaos.platform.internal.display.LiveDisplayService.TWILIGHT_CHANGED;
...
public abstract class LiveDisplayFeature {
    ...
    protected final String getString(String setting) {
        return EunoiaSettings.System.getStringForUser(mContext.getContentResolver(),
                setting, UserHandle.USER_CURRENT);
    }

    protected final void putString(String setting, String value) {
        EunoiaSettings.System.putStringForUser(mContext.getContentResolver(),
                setting, value, UserHandle.USER_CURRENT);
    }
