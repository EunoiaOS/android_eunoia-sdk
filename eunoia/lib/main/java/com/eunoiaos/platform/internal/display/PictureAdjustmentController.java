...
public class PictureAdjustmentController extends LiveDisplayFeature {
    ...
    public PictureAdjustmentController(Context context, Handler handler) {
        ...
        mHardware = EunoiaHardwareManager.getInstance(context);
        mHasDisplayModes = mHardware.isSupported(EunoiaHardwareManager.FEATURE_DISPLAY_MODES);

        boolean usePA = mHardware.isSupported(EunoiaHardwareManager.FEATURE_PICTURE_ADJUSTMENT);
        if (usePA) {
    ...
    public void onStart() {
        ...
        registerSettings(
                EunoiaSettings.System.getUriFor(EunoiaSettings.System.DISPLAY_PICTURE_ADJUSTMENT));
    }
    ...
    private SparseArray<HSIC> unpackPreference() {
        ...
        String pref = getString(EunoiaSettings.System.DISPLAY_PICTURE_ADJUSTMENT);
        if (pref != null) {
    ...
    private void packPreference(final SparseArray<HSIC> modes) {
        ...
        putString(EunoiaSettings.System.DISPLAY_PICTURE_ADJUSTMENT, sb.toString());
    }
