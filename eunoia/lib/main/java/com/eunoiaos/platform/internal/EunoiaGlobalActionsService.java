...
import static eunoiaos.providers.EunoiaSettings.Secure.POWER_MENU_ACTIONS;
import static eunoiaos.providers.EunoiaSettings.Secure.getStringForUser;
import static eunoiaos.providers.EunoiaSettings.Secure.putStringForUser;

import static com.eunoiaos.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static com.eunoiaos.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import eunoiaos.app.IEunoiaGlobalActions;

import com.eunoiaos.internal.util.PowerMenuConstants;
 ...
 * @hide
 */
public class EunoiaGlobalActionsService extends EunoiaSystemService {

    private static final String TAG = "EunoiaGlobalActions";
    ...
    public EunoiaGlobalActionsService(Context context) {
        super(context);
    ...
    public String getFeatureDeclaration() {
        return EunoiaContextConstants.Features.GLOBAL_ACTIONS;
    }

    @Override
    public void onStart() {
        publishBinderService(EunoiaContextConstants.EUNOIA_GLOBAL_ACTIONS_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new IEunoiaGlobalActions.Stub() {
