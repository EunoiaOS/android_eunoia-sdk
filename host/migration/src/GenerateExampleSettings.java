...
/**
 * This is to be run on a live Eunoia 12.1 device.
 */
public class GenerateExampleSettings {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for (Setting system : androidSystemSettingList) {
            if (EunoiaSettings.System.isLegacySetting(system.getKey())) {
                defaultSettings.add(system);
            }
        }

        for (Setting secure : androidSecureSettingList) {
            if (EunoiaSettings.Secure.isLegacySetting(secure.getKey())) {
                defaultSettings.add(secure);
            }
        }

        for (Setting global : androidGlobalSettingList) {
            if (EunoiaSettings.Global.isLegacySetting(global.getKey())) {
        ...
        out.write("# Settings which are to be moved to EunoiaSettings\n");
        out.write("# Automatically generated by " +
                "eunoiaosdk/host/migration/src/GenerateExampleSettings"
